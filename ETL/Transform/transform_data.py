...
def transform(df: pd.DataFrame):
    ...
    try:
        ...
        df_transformed['preco_promocional'] = (df_transformed['price'] * 0.90).round(2)
        ...
        #Salvando DataFrame com os dados transformados na pasta processed
